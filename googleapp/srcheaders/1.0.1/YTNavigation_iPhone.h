...
#import "YTNavigation-Protocol.h"

@class UINavigationController, YTGuideViewController_iPhone, YTSearchController, YTSearchView_iPhone, YTToastController;

@interface YTNavigation_iPhone : _AVAudioSessionCategoryPlayback <YTNavigation>
{
    UINavigationController *rootNavigationController_;
    YTGuideViewController_iPhone *guideViewController_;
    UINavigationController *navigationController_;
    YTSearchView_iPhone *searchView_;
    YTSearchController *searchController_;
    YTToastController *toastController_;
    id <YTServices> services_;
}

- (BOOL)controllerStacksOnWatch:(id)fp8;
- (void)pushViewController:(id)fp8 fromView:(id)fp12;
