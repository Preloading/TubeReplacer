...
// the people at google spun this off into a brand new class... yay!
@interface YTGDataRequestFactory
...
-(YTStream*)selectStreamForVideo:(YTVideo*)video devicePrivileges:(id)devicePrivileges;
